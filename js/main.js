...
Container.style.transformOrigin = "50% 100% " + Wall_width / 2 + "px";
...
function move(e) {
    ...
    Container.style.transformOrigin = innerWidth / 2 - x + "px " + "100% " + (Wall_width/2 - z) + "px"; // changing anchor point to current position
